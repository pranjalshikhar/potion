...
const ERROR_MESSAGES = {
  fileTooLarge(maxSize: number) {
    return `The file size is too large. Max size is ${formatFileSize(
      maxSize
    )}.`;
  },
  ...
  tooManyFiles(maxFiles: number) {
    return `You can only add ${maxFiles} files(s).`;
  },
      ...
      <div className="relative">
        ...
        >
          ...
          {imageUrl && !disabled && (
            ...
            >
              <div className="flex h-5 w-5 items-center justify-center rounded-md border-solid border-gray-500 bg-white transition-all duration-300 hover:h-6 hover:w-6 dark:border-gray-400 dark:bg-black">
                <X
